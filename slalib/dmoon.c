...
**
**  Defined in slamac.h:  DD2R, DAS2R, DS2R
**
**  Last revision:   8 December 1994
**
...
/* Moon's mean longitude */
   elp = DD2R * fmod ( elp0 + ( elp1 + ( elp2 + elp3 * t ) * t ) * t,
                                                                    360.0 );
   delp = DD2R * ( elp1 + ( 2.0 * elp2 + 3.0 *elp3 * t ) * t );

/* Sun's mean anomaly */
   em = DD2R * fmod ( em0 + ( em1 + ( em2 + em3 * t ) * t ) * t, 360.0 );
   dem = DD2R * ( em1 + ( 2.0 * em2 + 3.0 * em3 * t ) * t );

/* Moon's mean anomaly */
   emp = DD2R * fmod ( emp0 + ( emp1 + ( emp2 + emp3 * t ) * t ) * t,
                                                                    360.0 );
   demp = DD2R * ( emp1 + ( 2.0 * emp2 + 3.0 * emp3 * t ) * t );

/* Moon's mean elongation */
   d = DD2R * fmod ( d0 + ( d1 + ( d2 + d3 * t ) * t ) * t, 360.0 );
   dd = DD2R * ( d1 + ( 2.0 * d2 + 3.0 * d3 * t ) * t );

/* Mean distance of the Moon from its ascending node */
   f = DD2R * fmod ( f0 + ( f1 + ( f2 + f3 * t ) * t ) * t, 360.0 );
   df = DD2R * ( f1 + ( 2.0 * f2 + 3.0 * f3 * t ) * t );

/* Longitude of the Moon's ascending node */
   om = DD2R * fmod ( om0 + ( om1 + ( om2 + om3 * t ) * t ) * t, 360.0 );
