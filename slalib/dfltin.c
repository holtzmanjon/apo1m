...
/* Definitions and variables shared between slaDfltin and idchf */
static int idchf (void);
#define NUMBER 0
#define SPACE  1
#define EXPSYM 2
#define PERIOD 3
...
/* Copy string pointer for idchf function */
   p_string = string;
