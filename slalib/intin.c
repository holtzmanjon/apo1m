...
/* Definitions and variables shared between slaIntin and idchi */
static int idchi (void);
#define NUMBER 0
#define SPACE  1
#define PLUS   2
#define MINUS  3
