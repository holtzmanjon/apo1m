...
// +------------------------------------------------------------------------------------+
   ...
   extern "C" {		// Using a C++ compiler
	...
	//  Device access
	// +-------------------------------------------------+
	ARCCAM_API void ArcCam_GetDeviceList( struct ArcCAPIDevList* pDevList, struct ArcCAPIStatus* pStatus );
	...
	ARCCAM_API void ArcCam_OpenWithBuffer( int dDevNum, int dBytes, struct ArcCAPIStatus* pStatus );
	ARCCAM_API void ArcCam_OpenByName( const char* pszDeviceName, struct ArcCAPIStatus* pStatus );
	ARCCAM_API void ArcCam_OpenByNameWithBuffer( const char* pszDeviceName, int dBytes, struct ArcCAPIStatus* pStatus );
	ARCCAM_API void ArcCam_Close();
	ARCCAM_API void ArcCam_Reset( struct ArcCAPIStatus* pStatus );

	ARCCAM_API void  ArcCam_MapCommonBuffer( int dBytes, struct ArcCAPIStatus* pStatus );
	ARCCAM_API void  ArcCam_UnMapCommonBuffer( struct ArcCAPIStatus* pStatus );
	ARCCAM_API void  ArcCam_ReMapCommonBuffer( int dBytes, struct ArcCAPIStatus* pStatus );
	ARCCAM_API int   ArcCam_GetCommonBufferProperties( struct ArcCAPIStatus* pStatus );
	ARCCAM_API void  ArcCam_FillCommonBuffer( unsigned short u16Value, struct ArcCAPIStatus* pStatus );
	...
	ARCCAM_API void ArcCam_Set2xFOTransmitter( int dOnOff, struct ArcCAPIStatus* pStatus );
	ARCCAM_API void ArcCam_LoadDeviceFile( const char* pszFile, struct ArcCAPIStatus* pStatus );

	//  Setup & General commands
	// +-------------------------------------------------+
	ARCCAM_API int  ArcCam_Command( int dBoardId, int dCommand, int dArg1, int dArg2, int dArg3,
									int dArg4, struct ArcCAPIStatus* pStatus );

	ARCCAM_API int  ArcCam_Cmd1Arg( int dBoardId, int dCommand, int dArg1, struct ArcCAPIStatus* pStatus );
	ARCCAM_API int  ArcCam_Cmd2Arg( int dBoardId, int dCommand, int dArg1, int dArg2, struct ArcCAPIStatus* pStatus );
	ARCCAM_API int  ArcCam_Cmd3Arg( int dBoardId, int dCommand, int dArg1, int dArg2, int dArg3, struct ArcCAPIStatus* pStatus );
	...
	ARCCAM_API void ArcCam_SetupController( int dReset, int dTdl, int dPower, int dRows, int dCols, const char* pszTimFile,
											const char* pszUtilFile, const char* pszPciFile, int* pAbort,
											struct ArcCAPIStatus* pStatus );

	ARCCAM_API void ArcCam_LoadControllerFile( const char* pszFilename, int dValidate, int* pAbort, struct ArcCAPIStatus* pStatus );
	ARCCAM_API void ArcCam_SetImageSize( int dRows, int dCols, struct ArcCAPIStatus* pStatus );
	...
	ARCCAM_API int  ArcCam_IsCCParamSupported( int dParameter, struct ArcCAPIStatus* pStatus );
	ARCCAM_API int  ArcCam_IsCCD( struct ArcCAPIStatus* pStatus );

	ARCCAM_API int  ArcCam_IsBinningSet( struct ArcCAPIStatus* pStatus );

	ARCCAM_API void ArcCam_SetBinning( int dRows, int dCols, int dRowFactor, int dColFactor, int* pBinRows,
									   int* pBinCols, struct ArcCAPIStatus* pStatus );

	ARCCAM_API void ArcCam_UnSetBinning( int dRows, int dCols, struct ArcCAPIStatus* pStatus );

	ARCCAM_API void ArcCam_SetSubArray( int* pOldRows, int* pOldCols, int dRow, int dCol, int dSubRows, int dSubCols,
										int dBiasOffset, int dBiasWidth, struct ArcCAPIStatus* pStatus );

	ARCCAM_API void ArcCam_UnSetSubArray( int dRows, int dCols, struct ArcCAPIStatus* pStatus );

	ARCCAM_API int  ArcCam_IsSyntheticImageMode( struct ArcCAPIStatus* pStatus );
	ARCCAM_API void ArcCam_SetSyntheticImageMode( int dMode, struct ArcCAPIStatus* pStatus );

	//  Expose commands
	// +-------------------------------------------------+
	ARCCAM_API void ArcCam_SetOpenShutter( int dShouldOpen, struct ArcCAPIStatus* pStatus );

	ARCCAM_API void ArcCam_Expose( float fExpTime, int dRows, int dCols, int* pAbort, void ( *pExposeCall )( float ),
	...
	ARCCAM_API void ArcCam_Continuous( int dRows, int dCols, int dNumOfFrames, float fExpTime, int* pAbort,
	...
	ARCCAM_API double ArcCam_GetArrayTemperatureDN( struct ArcCAPIStatus* pStatus );
	ARCCAM_API void   ArcCam_SetArrayTemperature( double gTempVal, struct ArcCAPIStatus* pStatus );
	ARCCAM_API void   ArcCam_LoadTemperatureCtrlData( const char* pszFilename, struct ArcCAPIStatus* pStatus );
	ARCCAM_API void   ArcCam_SaveTemperatureCtrlData( const char* pszFilename, struct ArcCAPIStatus* pStatus );


	// +============================================================================+
	// | CDeinterlace functions                                                     |
	// +============================================================================+
	ARCCAM_API void ArcCam_Deinterlace( void *pData, int dRows, int dCols, int dAlgorithm,
										struct ArcCAPIStatus* pStatus );

	ARCCAM_API void ArcCam_DeinterlaceWithArg( void *pData, int dRows, int dCols, int dAlgorithm,
	...
	// | CFitsFile functions                                                        |
	// +============================================================================+
	ARCCAM_API void ArcCam_WriteToFitsFile( const char* pszFilename, void* pData, int dRows,
