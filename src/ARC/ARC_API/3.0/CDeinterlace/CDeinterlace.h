...
namespace arc
{
	...
	// +------------------------------------------------------------+
	// | CDeinterlace class definition                              |
	// +------------------------------------------------------------+
	class CDEINTERLACE_API CDeinterlace
	{
		public:
			CDeinterlace();
			virtual ~CDeinterlace();


			//  Smart pointer deleter  ( Users should NEVER call this method )
			// +--------------------------------------------------------------------+
			static void Deleter( unsigned short* d );
		...
		private:
			std::tr1::shared_ptr<unsigned short> m_pNewData;
