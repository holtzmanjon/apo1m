...
// |  Throws std::runtime_error on error
// |
// |  <IN> -> pszFilename - The SMALLCAM or GENI/II/III TIM or UTIL lod file to
// |                        load.
...
//	double* pgTemperature		= new double[ gTmpCtrl_SDNumberOfReads ];
	std::tr1::shared_ptr<double> pgTemperature( new double[ gTmpCtrl_SDNumberOfReads ], ArrayDeleter<double>() );
