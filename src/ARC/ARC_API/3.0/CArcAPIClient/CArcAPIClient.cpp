...
// see CArcAPIClient.h for the class definition
...
// /////////////////////////////////////////////////////////////////////////////
//
void CArcAPIClient::Connect( const char* szIPAddr, unsigned short usPort )
{
...
//		CloseConnections();
	...
	tServerInfo.sin_addr.s_addr = inet_addr( szIPAddr );
	tServerInfo.sin_port        = htons( usPort );		// Change to network-byte order and
...
//	cout << "Connected to: " << inet_ntoa( tServerInfo.sin_addr ) << endl;
	...
	{
		ostringstream oss;
		oss << "Failed to connect to server: " << szIPAddr;
	...
	else
	{
		...
		if ( dRetVal != SOCKET_ERROR )
		{
			...
			else
			{
				...
				oss << "WSAWaitForMultipleEvents error: "
					<< GetSystemMessage( GetError() )
					<< ends;
...
//	shutdown( m_tSocket, SD_BOTH );
//	WSASendDisconnect( m_tSocket, NULL );
...
void CArcAPIClient::SendInvalidCommand( const char* szCmd )
{
	Send( szCmd );
...
// /////////////////////////////////////////////////////////////////////////////
//
void CArcAPIClient::GetDirListing( const std::string sTargetDir, vector<std::string>& vecDirList, bool bSearchSubDir )
{
...
void CArcAPIClient::LogMsgOnServer( const char* szMsg )
{
	Send( "%s::%s %s",
		   CLASS_CArcAPIServer,
...
// /////////////////////////////////////////////////////////////////////////////
//
const char* CArcAPIClient::ToString()
{
...
void CArcAPIClient::DetectServers( unsigned short usPort )
{
	...
	for ( int i=2; i<255; i++ )
	{
		...
		SenderAddr.sin_addr.s_addr = inet_addr( oss.str().c_str() ); ;
