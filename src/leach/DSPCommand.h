...
#define TBS	0x00544253	/* Test Byte Swapping			*/
#define SBS	0x00534253	/* Set Byte Swapping			*/
...
******************************************************************************/
	...
	#define ASTROPCI_GET_DMA_SIZE \
		CTL_CODE(ASTROPCI_DEVICE, 0x806, METHOD_BUFFERED, FILE_ANY_ACCESS)

	#define ASTROPCI_GET_FRAMES_READ \
		CTL_CODE(ASTROPCI_DEVICE, 0x807, METHOD_BUFFERED, FILE_ANY_ACCESS)
	...
	#define ASTROPCI_GET_FRAMES_READ	0x5
...
int setHardwareByteSwapping(HANDLE pci_fd);
int getError();
